  ...
  return (
    <div>
      <header>
        ...
        <h1 className="text-center fw-bold text-white mt-3" id='service' >OUR SERVICES</h1>
        
        <div className="card col-4 m-4 text-center bg-black border border-3 rounded-0 card-course" style={{ width: '23rem' }}>
          <img
            ...
            alt="Data Science"
          />
          <div className="card-body text-white" id='title1' >
        ...
        <div className="card col-4 m-4 text-center bg-black border border-3 rounded-0 card-course" style={{ width: '22rem' }}>
          ...
          />
          <div className="card-body text-white"  id='title2'>
        ...
        <div className="card col-4 m-4 text-center bg-black border border-3 rounded-0 card-course" style={{ width: '22rem' }}>
          ...
          />
          <div className="card-body text-white" id='title3'>
        ...
        <div className="card col-4 m-4 text-center bg-black border border-3 rounded-0 card-course" style={{ width: '22rem' }}>
          <img
            ...
            alt="Analytics"
          />
          <div className="card-body text-white" id='title4'>
        ...
        <div className="card col-4 m-4 text-center bg-black border border-3 rounded-0 card-course" style={{ width: '22rem' }}>
          <img
            ...
            alt="AWS"
          />
          <div className="card-body text-white" id='title5'>
        ...
        <div className="card col-4 m-4 text-center bg-black border border-3 rounded-0 card-course" style={{ width: '22rem' }}>
          <img
            ...
            alt="DevOps"
          />
          <div className="card-body text-white" id='title6'>
